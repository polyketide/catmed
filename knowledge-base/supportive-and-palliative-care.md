...
## 10. Nutraceuticals / adjuncts — an indication-first check (anaemia and liver injury)

Owners frequently ask whether to "add something" for a low haematocrit or a stressed liver. The useful question is almost never *"is there evidence for X"* — it is *"does this animal's current state actually constitute an indication for X"*. Answered that way, both of the common requests below usually resolve to **no, not now**, without that meaning the substance is worthless.

**One principle running through both: "no harm reported" is not "benefit proven."** A review stating a supplement caused "no problems" is reporting an absence of harm data, not efficacy in a healthy organ.

### 10.1 Anaemia — classify before you supplement; the fork decides everything

**First split on regeneration (reticulocyte count):**

- **Regenerative** (retic ↑) → blood loss or haemolysis → **find and stop the source** (GI bleed, parasites, immune-mediated haemolysis). Iron only if chronic blood loss has produced confirmed iron deficiency.
- **Non-regenerative** (retic not raised) → sub-classify, because the most common trap lives here.

**The non-regenerative sub-types, and what each actually needs:**

1. **Anaemia of inflammation / chronic disease (ACD/AI)** — the commonest anaemia in cancer and chronic-inflammatory patients. The mechanism is the point: inflammatory cytokines raise **hepcidin**, which **blocks intestinal iron absorption and locks iron inside cells** — iron-restricted erythropoiesis in a body that is *not* iron-deficient (Weiss 2019, *Blood*). Consequences for supplements:
...
**First, is there real injury?** Read liver enzymes (ALT/AST/ALP/GGT) *and* function markers (bilirubin, albumin, cholesterol, glucose, bile acids). **All normal → no indication.** The evidence for hepatoprotectants was generated almost entirely in animals that already had liver disease or raised enzymes; **prophylactic use in an animal with normal liver function is unsupported.**

**If injury is present, identify the cause and treat it first; the hepatoprotectant is an *adjunct*, not the primary therapy.**

**Evidence state, graded honestly:**
- **Milk thistle (silymarin/silybin)** — canine data support adjunctive use, but they are small and observational; a review notes that **no problems were reported** with administration (Tedesco 2022, *Planta Med*). Absence of reported harm is not proof of benefit in a healthy liver.
- **SAMe** — there *is* a feline randomised trial, but its indication is an **acetaminophen (paracetamol) oxidative-injury model**, where SAMe limited Heinz-body formation and erythrocyte destruction (Webb 2003, *JFMS*). It does not generalise to other causes of liver injury.

**Indication-driven, not stacked "just in case":**
- Hepatoprotectants earn their place when there is **actual liver injury**, or when a **known hepatotoxic drug is about to be used** (e.g. lomustine/CCNU) — as a drug-specific adjunct.
- **Not "harmless, so add it."** Every oral medication is a dosing event, and in a patient with a compromised airway or swallowing difficulty each pill carries aspiration risk (see §9). **An unindicated pill is not free.**

### 10.3 Shared rule for both

**"There is evidence" ≠ "this animal needs it now."** Evidence only reaches the patient through the indication. Classify first (anaemia: regenerative → sub-type; liver: injury present → cause), treat the cause rather than substituting a supplement for it, and count every added oral drug against administration burden and aspiration risk. A finding that an animal *does not need* a supplement now is not a finding that the class is *never* useful — record the indication logic, not a "supplements don't work" label.
...
- Anaemia of inflammation / iron: Weiss 2019 Blood, PMID 30401705 (hepcidin, iron-restricted erythropoiesis, ACD as diagnosis of exclusion — human/mechanistic); Malesza 2022 Nutrients, PMID 36079734 (harms of iron supplementation in inflammatory states — human/narrative review).
- Anaemia treatment (feline): Chalhoub 2012 JVIM, PMID 22296687 (darbepoetin in CKD anaemia, 14/25 responders — renal, not tumour-related).
- Hepatoprotectants: Tedesco 2022 Planta Med, PMID 36302565 (milk thistle review, farm + companion animals — mostly canine/observational); Webb 2003 JFMS, PMID 12670431 (SAMe feline RCT, acetaminophen oxidative-injury model only).
...
**PMID 30401705** · Weiss G 2019 (human/mechanistic review — anaemia of inflammation)
> Inflammation-inducible cytokines and the master regulator of iron homeostasis, hepcidin, block intestinal iron absorption and cause iron retention in reticuloendothelial cells, resulting in iron-restricted erythropoiesis.
> Although the diagnosis of AI is a diagnosis of exclusion and is supported by characteristic alterations in iron homeostasis, hypoferremia, and hyperferritinemia, the diagnosis of AI patients with coexisting iron deficiency is more difficult.
> ⚠️ Human. Cited for the mechanism (hepcidin-driven iron restriction) and for ACD being a diagnosis of exclusion — the reason oral iron is ineffective and iron status must be confirmed before supplementing, not for any feline measurement.
...
> Anemia is present in 30-65% in cats with chronic kidney disease (CKD) and few long-term treatment options exist.
> ⚠️ Feline, but the anaemia is renal (reduced erythropoietin), not tumour-related. Cited to show the evidence-based option is a prescription ESA, not a supplement; do not transfer the response rate to anaemia of inflammation.

**PMID 36302565** · Tedesco DEA 2022 (review — milk thistle in animals)
> A few studies reported no effects, but none reported problems connected to milk thistle administration.
> In dogs and cats, the treatment is focused on acute and chronic liver diseases including the detoxification processes and support of drug treatments including chemotherapy.
> ⚠️ Review spanning farm and companion animals; companion-animal evidence is largely canine and observational. The "none reported problems" sentence is absence of reported harm, not proof of benefit in a healthy liver.

**PMID 12670431** · Webb CB 2003 (feline RCT — SAMe, acetaminophen model)
> SAMe protected erythrocytes from oxidative damage by limiting Heinz body formation and erythrocyte destruction and maybe useful in treating acetaminophen toxicity.
> ⚠️ The indication tested is an acetaminophen (paracetamol) oxidative-injury model. Cited as the one feline RCT for SAMe; it does not generalise to other causes of liver injury.
